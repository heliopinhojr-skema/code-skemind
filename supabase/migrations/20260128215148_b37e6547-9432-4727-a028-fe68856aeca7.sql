-- Fix: Remove ::TEXT cast from CURRENT_DATE in register_player function
-- The column last_refill_date is of type DATE, not TEXT
...
BEGIN
  ...
  -- Create profile (FIX: use CURRENT_DATE without ::TEXT cast)
  INSERT INTO profiles (
    ...
    v_initial_energy,
    v_new_tier,
    CURRENT_DATE  -- ✅ Fixed: removed ::TEXT cast
  )
